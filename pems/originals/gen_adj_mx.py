...
if __name__ == '__main__':
    ...
    parser.add_argument('--sensor_ids_filename', type=str, default='./graph_sensor_ids_pems.txt',
                        help='File containing sensor ids separated by comma.')
    parser.add_argument('--distances_filename', type=str, default='./distances_bay_2017.csv',
    ...
    parser.add_argument('--output_pkl_filename', type=str, default='./adj_mx_bay_dcrnn.pkl',
