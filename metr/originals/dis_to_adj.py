...
df = pd.read_excel("ave_time.xlsx", index_col=0)
A = df.values
A = A/ 70000.0 * 60.0
mean_df =pd.DataFrame(A)
mean_df.to_excel("tmp.xlsx")
print(A)

#
# def create_distance_matrix():
#     distance_path = 'distances_la_2012.csv'
#     num_ids = 207
#     id_to_index = {}
#     index_to_id = {}
#     ids = []
...
#     # df.to_excel(path3)
#
#     f = open('adj_mx_metr_rmasthru.pkl', 'wb+')
